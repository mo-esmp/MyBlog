...
namespace MyBlog.Common.Helpers
{
    public class CultureHelper
    {
        ...
        private static readonly Dictionary<string, string> ValidCultures = new Dictionary<string, string>
        {
            {"en", "en-us"},
            {"en-us", "en-us"},
            {"fa", "fa-ir"},
        ...
        public static string DefaultCulture
        {
            get
            {
                ...
                return defaultCulture ?? ValidCultures["fa"];
            }
        }
        ...
        /// <returns>Return implemented culture or default culture</returns>
        public static string GetImplementedCulture(string name)
        {
            try
            {
                return ValidCultures[name];
            }
            catch (Exception)
            {
