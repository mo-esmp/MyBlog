    ...
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Application_AcquireRequestState()
        {
            ...
            HttpContext.Current.Session["OsSpecificCss"] =
                HttpContext.Current.Request.UserAgent.IndexOf("Windows NT 6.2", StringComparison.InvariantCultureIgnoreCase) > -1 ||
                HttpContext.Current.Request.UserAgent.IndexOf("Windows NT 6.3", StringComparison.InvariantCultureIgnoreCase) > -1 ||
                HttpContext.Current.Request.UserAgent.IndexOf("Windows NT 10", StringComparison.InvariantCultureIgnoreCase) > -1
                ? HttpContext.Current.Session["OsSpecificCss"] = ""
